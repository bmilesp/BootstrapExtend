...
Configure::write('BootstrapExtend.autoAssets.css.datepicker', 'BootstrapExtend.bootstrap-datetimepicker.min');
Configure::write('BootstrapExtend.autoAssets.js.moment', 'BootstrapExtend.moment.min');
Configure::write('BootstrapExtend.autoAssets.js.datepicker', 'BootstrapExtend.bootstrap-datetimepicker.min');

//default select auto assets	
Configure::write('BootstrapExtend.autoAssets.css.bootstrap-select', 'BootstrapExtend.bootstrap-select.min');
Configure::write('BootstrapExtend.autoAssets.js.bootstrap-select', 'BootstrapExtend.bootstrap-select.min');
